...
"secure.baseUrl":"http://route{serviceMode}.api.here.com/routing/7.2/",protocol:"nokia.maps.routing.navteq.protocolV72"};l.assetsPath=l.assetsPath||"assets/ovi/mapsapi";l.adbarCss=l.adbarCss||"adbar.css";l.tileProviders=l.tileProviders||"nokia.maps.map.js.nlpTileProviders";l.copyrightsInclude=l.copyrightsInclude||"nokia.maps.map._Copyright";l.copyrights=l.copyrights||"https://1.base.maps{serviceMode}.api.here.com/maptile/2.1/copyright/newest";l["language.warnOnMissingTranslation"]=l["language.warnOnMissingTranslation"]||
...
(function(e){function l(b){a.test(b)||e.util.d("alignment '"+b+"'");this.Ti.lo(b);return b}var h=e.dom,d=Math.floor,c=e.util,g=new e.language.Manager,b=c.Point,f=new Image,r="assets/here_logo.png",a=/^(top|middle|bottom)(left|center|right)$/,q;f.src=r;e.map.uo=new ovi.Class({initialize:function(a){var b,d;this.ga=a;q=ovi.Array([a.SATELLITE,a.SATELLITE_PLAIN,a.SATELLITE_COMMUNITY,a.GLOBE,a.PANORAMA]);b=this.Qo=h.gb(a.Ui,"div");b.innerHTML=e.resources.copyright.html;this.bo=
